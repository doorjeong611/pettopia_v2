...
const getDefaultEvents = () => {
    ...
    return [
        ...
        { title: 'Lunch', start: new Date(y, m, d, 9, 0), end: new Date(y, m, d, 14, 0), allDay: false, className: 'text-purple-500 w-[100%] !bg-purple-100 dark:!bg-purple-500/20 border-none rounded-md py-1.5 px-3' },
...
// Localization
const changeLocale = () => calendar.setOption('locale', 'kr');
