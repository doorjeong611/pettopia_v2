							    ...
							    <div>
	                                <div class="contentFooterBox">
	                                    ...
	                                    <c:if test="${empNo == boardMap.boardWriterNo}">
	                                        <div class="btnBox">
	                                            <div class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600" ><a href="${pageContext.request.contextPath}/board/modifyBoard?boardNo=${boardMap.boardNo}&boardCategory=${boardCategory}">수정하기</a></div>
