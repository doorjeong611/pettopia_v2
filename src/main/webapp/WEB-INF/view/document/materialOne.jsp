							...
							<table style="border: 1px solid; width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; margin-top: 10px; border-collapse: collapse; height: 600px;"><colgroup> 
	                        	...
	                        	<tbody>
									...
									<tr>
										...
										<td style="background: rgb(255, 255, 255); padding: 5px;border:1px solid black; height: 40px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"  colspan="3">
											<span id="materialName" data-title="${documentOne.materialName}" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px; padding-left: 10px; vertical-align: middle;">
												${documentOne.materialName}
											</span>
										</td>
									</tr>
									<tr>
										...
										<td style="background: rgb(255, 255, 255); padding: 5px;border:1px solid black; height: 40px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle; width: 300px;">
											<span id="docPrice" data-title="${documentOne.docPrice}" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px; padding-left: 10px; vertical-align: middle;">
												<fmt:formatNumber value="${documentOne.docPrice}" type="number" pattern="#,##0"/> 원
											</span>
										</td>
										<td style="background: rgb(221, 221, 221); padding: 5px; border: 1px solid black; height: 40px; text-align: center; color: rgb(0, 0, 0); font-size: 13px; font-weight: bold; vertical-align: middle; min-width: 160px;">
											수&nbsp;&nbsp;&nbsp;량
										...
										<td style="background: rgb(255, 255, 255); padding: 5px;border:1px solid black; height: 40px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle; min-width: 300px;">
											<span id="materialQuantity" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px; padding-left: 10px; vertical-align: middle;">
												${documentOne.materialQuantity} 개
											</span>
										</td>
									</tr>
									<tr>
										...
										<td style="background: rgb(255, 255, 255); padding: 5px;border:1px solid black; height: 40px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"  colspan="3">
											<span id="docPurpose" data-title="${documentOne.docPurpose}" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px; padding-left: 10px; vertical-align: middle;">
												${documentOne.docPurpose}
											</span>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 480px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;" colspan="4">
