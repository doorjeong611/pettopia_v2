                                ...
                                <form id="formAddDocument" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/document/addDocument">
                                   ...
                                   <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12" style="border: 1px solid red;">
									    ...
									    <div class="col-span-1">
									        ...
									        <input type="text" id="docTitle" name="docTitle" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"  value="고객 서비스" readonly >
									    </div>
									    <div class="col-span-1 lg:col-span-8 xl:col-span-9">
									        ...
									        <input type="text" id="docTitle" name="docTitle" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400"  value="제목있" readonly >
									    </div><!--end col-->
									    
									    <!-- 작성자, 작성일, 조회수 -->
									    <div class="col-span-1 lg:col-span-3">
									        <label for="docWriterNo" class="inline-block mb-2 text-base font-medium">작성자</label> 
									        <input type="text" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" value="글쓴이" readonly>
									    </div><!--end col-->
									    <div class="col-span-1 lg:col-span-3">
									        <label for="docWriterNo" class="inline-block mb-2 text-base font-medium">작성일</label> 
									        <input type="text" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" value="작성일" readonly>
									    </div><!--end col-->
									    <div class="col-span-1 lg:col-span-3">
									        <label for="docWriterNo" class="inline-block mb-2 text-base font-medium">조회수</label>
									        <input type="text" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" value="조회수" readonly>
									    </div><!--end col-->
                                        ...
                                        <div id="documentDiv" class="lg:col-span-2 xl:col-span-12" style="display:block;">
                                            <div>
                                                ...
                                                <textarea name="docContent" class="form-input border-slate-200 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 disabled:border-slate-300 disabled:text-slate-500 placeholder:text-slate-400" id="docContent" placeholder="문서 유형을 먼저 선택하세요" rows="10" readonly>내용</textarea>
                                            </div>
                                        </div>
